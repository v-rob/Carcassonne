...
public interface GamePlayer {
	...
	public abstract void gameSetAsGui(com.example.carcassonne.GameMainActivity activity);
	
	// sets this player as the GUI player (overrideable)
	public abstract void setAsGui(com.example.carcassonne.GameMainActivity activity);
